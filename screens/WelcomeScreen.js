      ...
      <View style={styles.overlay}>
        <View style={styles.content}>
          ...
          <Text style={styles.quote}>
            From your first steps to your personal best, we’re with you every kilometer.
          </Text>

    

          <Button mode="contained" buttonColor='#5335DA' style={styles.button} onPress={() => navigation.navigate('Register')}>
