        ...
        <View style={styles.participants}>
          {item.participants.map((participant, index) => (
            <View key={index} style={styles.participantItem}>
              ...
              />
              <Text style={styles.participantName} variant="labelLarge">{participant.name}</Text>
            </View>
          ))}
        </View>
    ...
    <View style={styles.container}>
      <View style={styles.rowContainer}>
        <TouchableOpacity onPress={() => setActiveTab("Feed")}>
            <Text style={[styles.text, activeTab === "Feed" && styles.activeTabText]}>Community Feed</Text>
        </TouchableOpacity>
         <TouchableOpacity onPress={() => setActiveTab("Challenges")}>
          <Text style={[styles.text, activeTab === "Challenges" && styles.activeTabText]}>Challenges</Text>
        </TouchableOpacity>
      </View>
      {activeTab === "Feed" ? (
...
const styles = StyleSheet.create({
  ...
  text: { paddingHorizontal: 10, marginVertical: 5 },
  activeTabText: { fontWeight: "bold", color: "black", textDecorationLine: "underline" },
