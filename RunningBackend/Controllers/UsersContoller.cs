...
namespace RunningBackend.Controllers
{
	...
	public class UsersController : ControllerBase
	{
		...
		[HttpGet("{userId}/data")]
		public async Task<IActionResult> GetUserByIdWithCounts(string userId)
		{
			...
			await Task.WhenAll(userTask, followerCountTask, followingCountTask, firstRunTask, followersTask, followingTask, monthlyStatsTask);
		...
		private async Task<object> GetMonthlyStats(string userId)
		{
			...
			// Fetch the user's runs for the last month
			...
			// Prepare and return the monthly stats
			return new
			{
				Period = "Last Month",
		...
		public async Task<IActionResult> SearchUsers([FromQuery] string query)
		{
			...
			// First, fetch the users from the database
		...
		public async Task<IActionResult> UploadImage([FromForm] IFormFile file, [FromForm] string userId)
		{
			...
			// Save the new image with a fixed filename (overwrites old image)
