...
export default function App() {
    ...
    <GlobalStack.Screen
        ...
        options={{ title: "Run Details", headerShown: true, headerBackTitle: "Back" }}
    />
 <GlobalStack.Screen
        name="ProfileScreen"
        component={ProfileScreen}
        options={{ title: "Profile", headerShown: true, headerBackTitle: "Back" }}
    />
     <GlobalStack.Screen
        name="AddFriendScreen"
        component={AddFriendScreen}
        options={{ title: "Add Friend", headerShown: true, headerBackTitle: "Back" }}
    />
   
    <GlobalStack.Screen
        name="UpdateUserDataScreen"
        component={UpdateUserDataScreen}
        options={{ title: "Update Data", headerShown: true, headerBackTitle: "Back" }}
    />
